...
function getRandomImageURL(): Promise<string> {
	return new Promise((resolve, reject) => {
		axios
			...
			.catch(() => {
				const defaultURL =
					'https://media.discordapp.net/attachments/878276279105884210/1045378789905010758/99083012_p7.jpg';
				resolve(defaultURL);
			});
	});
}

function getRandomImage(): Promise<{ data: Buffer; end: string } | null> {
	return new Promise((resolve, reject) => {
		getRandomImageURL()
			.then((url) => {
				axios
